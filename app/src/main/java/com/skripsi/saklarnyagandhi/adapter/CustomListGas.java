package com.skripsi.saklarnyagandhi.adapter;
...
public class CustomListGas extends BaseAdapter {
	private Activity activity;
	private LayoutInflater inflater;
	private List<Saklar> saklarItems;

	public CustomListGas(Activity activity, List<Saklar> saklarItems) {
			...
			public void onClick(View v) {
				...
				StringRequest stringRequest = new StringRequest(Request.Method.POST, Constant.url_gas,
					...
					protected Map<String, String> getParams() {
						...
						params.put("id_gas", m.getIdSaklar());
						params.put("status_gas", "hidup");
						return params;
					}
				};
